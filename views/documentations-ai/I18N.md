...
| `i18n.views.manage.no_collector` | My collector is not in the list | Mon collecteur n'est pas dans la liste |
...
| `i18n.views.manage.processing` | Processing | Traitement en cours |
...
| `i18n.views.manage.successfully_collected` | Successfully collected | Collecté avec succès |
| `i18n.views.manage.status_complete` | Status: Complete | Statut : Terminé |
| `i18n.views.manage.collection_failed` | Collection Failed | Échec de la collecte |
| `i18n.views.manage.status_failed` | Status: Failed | Statut : Échec |
...
| `i18n.views.manage.success` | Credential successfully added! New invoices will be sent to your email address. | Identifiants ajoutés avec succès ! Les nouvelles factures seront envoyées à votre adresse email. |
...
| `i18n.views.manage.website_url` | Website URL | URL du site web |
...
| Clé | EN | FR |
|-----|----|----|
| `i18n.views.manage.feedback` | User feedback | Retour utilisateur |
| `i18n.views.manage.send_feedback` | Send a user feedback | Envoyer un retour utilisateur |
| `i18n.views.manage.feedback.placeholder` | New collectors wanted, improvements, bugs, etc. | Nouveau collecteurs souhaité, améliorations, bugs, etc. |
| `i18n.views.manage.feedback.email.placeholder` | If you want to be contacted after your feedback | Si vous souhaitez être contacté suite à votre retour |
| `i18n.views.manage.feedback.success` | Thank you for your feedback! | Merci pour votre retour ! |
| `i18n.views.manage.feedback.error` | Error sending feedback | Erreur lors de l'envoi du retour |
