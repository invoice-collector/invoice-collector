...
| Clé | EN | FR |
|-----|----|----|
| `i18n.views.interactive.login.message` | Connect your account below, and then confirm your connection. | Connectez-vous ci-dessous, puis confirmez votre connexion. |
