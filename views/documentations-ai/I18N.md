...
| Clé | EN | FR |
|-----|----|----|
| `i18n.views.manage.page_title` | My collectors | Mes collecteurs |
...
| Clé | EN | FR |
|-----|----|----|
| `i18n.views.interactive.login.instructions` | Connect your account below, and then confirm your connection. | Connectez-vous ci-dessous, puis confirmez votre connexion. |
| `i18n.views.interactive.done` | Done | Terminé |
