...
async function callLlm(website, messageToLlm) {
    ...
    if (!mistralApiKey) {
        throw new Error("Missing CUA_MISTRALAI_API_KEY environment variable.");
    }
...
import { CollectorState, CollectorCaptcha, CollectorType, CollectorAuthenticationMethod } from '../../../collectors/abstractCollector';
