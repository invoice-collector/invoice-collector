...
export class Progress {
    ...
    static STEP_2_2FA_WAITING : Step = new Step(2, "Waiting for 2FA code...");
    static STEP_3_2FA_PROCEEDING : Step = new Step(3, "Proceeding with 2FA code...");
    static STEP_4_COLLECTING : Step = new Step(4, "Collecting new invoices...");
    static STEP_5_DOWNLOADING : Step = new Step(5, "Downloading invoices...");
    static STEP_6_DONE : Step = new Step(6, "Done!");

    static STATUS_DEFAULT : Status = {
        max: Progress.DEFAULT_MAX,
        index: Progress.DEFAULT_MAX,
        i18n: Progress.STEP_6_DONE.i18n
    }
