...
export class AdspyCollector extends SketchCollector {
    ...
    static CONFIG = {
        id: 'adspy',
        name: 'Adspy',
        description: 'i18n.collectors.adspy.description',
        version: '0',
        ...
        loginUrl: 'https://app.adspy.com/login',
    ...
    /**
     * Constructs a new instance of the AdspyCollector class.
     */
    constructor() {
        super(AdspyCollector.CONFIG);
    }
}
