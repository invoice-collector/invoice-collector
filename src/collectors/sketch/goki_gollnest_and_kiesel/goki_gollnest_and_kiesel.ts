...
export class GokiGollnestAndKieselCollector extends SketchCollector {
    ...
    static CONFIG = {
        ...
        loginUrl: 'https://goki.eu/de/customerDocumentList-customerDocumentListId-invoice.html',
    ...
    /**
     * Constructs a new instance of the GokiGollnestAndKieselCollector class.
     */
    constructor() {
