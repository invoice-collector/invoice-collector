...
export class MotionCollector extends SketchCollector {
    ...
    static CONFIG = {
        id: 'motion',
        name: 'Motion',
        description: 'i18n.collectors.motion.description',
        version: '0',
        ...
        loginUrl: 'https://app.usemotion.com/web/settings/billing',
    ...
    /**
     * Constructs a new instance of the MotionCollector class.
     */
    constructor() {
        super(MotionCollector.CONFIG);
    }
}
