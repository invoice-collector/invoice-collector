...
export class BreakoutClipsCollector extends SketchCollector {
    ...
    static CONFIG = {
        id: 'breakout_clips',
        name: 'BREAKOUT CLIPS',
        description: 'i18n.collectors.breakout_clips.description',
        version: '0',
    ...
    /**
     * Constructs a new instance of the BreakoutClipsCollector class.
     */
    constructor() {
        super(BreakoutClipsCollector.CONFIG);
    }
}
